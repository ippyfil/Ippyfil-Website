...
/***/ function(module, exports, __webpack_require__) {
	...
	//┘
		...
		var CartModule = function (params)
		{
			...
			// CREATES OBJECT WITH BASKET SETTINGS
			// ---------------------------------------------------------------------------------
	
			// container for cart settings
			TemplateOptions.vars = {}; 
	
			// expands the container with objects "Options.defaults", "TemplateOptions.defaults" и "params"
			...
			// CREATES CONTROLLER (INPUT POINT)
			// ---------------------------------------------------------------------------------
		...
		//┘
			...
			CartModule.prototype = 
			{
				...
				/**
				 *	Adds a product to the list of pending products
				 */
				...
				/**
				 *	Hides the cart components and frees up the module resources
				 */
	...
	//┘
		...
		module.exports = {
			...
			defaults: {
				...
				/** 
				 * Support for multiple units of one product
				 */
				...
				/** 
				 *	Support for the list of pending items
				 */
				...
				/** 
				 *	Link to checkout to send the contents of the cart
				 */
...
/***/ function(module, exports, __webpack_require__) {
	...
	//┘
		...
		var List = Backbone.Collection.extend(
		{
			...
			/**
				* Updates and returns the stats object:
				* @totalItems number of products
				* @totalQuantity total number of units
